...
**Примечание**: Высокий процент `http_req_failed` (16-55%) объясняется тем, что k6 считает 4xx/5xx ошибками, но для данного API статусы 400, 404, 409 являются валидными ответами в определенных сценариях. 
